---
sidebar_label: Tarifários e Disponibilidade - Inventário - Guia Rápido
title: Tarifários e Disponibilidade - Inventário - Guia Rápido
description: Guia rápido para utilizar e interpretar as informações da aba de inventário no sistema Omnibees.
slug: /
---
...
- *Disponibilidade*  
- *Ocupação*  
- *Total de apartamento por período*
...
Ao atualizar a disponibilidade, informe:

- Quais as datas a atualizar?  
  Informe o período desejado, podendo **+ Adicionar outro período**.

- Quais os quartos e disponibilidades a atualizar?  
  - Tipos de Quarto: selecione o tipo de quarto desejado, podendo **+ Adicionar outro quarto**.  
  - Apartamentos Disponíveis: informe a quantidade de quartos disponíveis.
...
- Quais os quartos e ocupações a atualizar?  
  - Tipos de Quarto: selecione o tipo de quarto desejado, podendo **+ Adicionar outro quarto**.  
  - Apartamentos Ocupados: informe a quantidade de quartos ocupados.
...
## 3. Total de apartamentos por período
...
- Qual é o quarto a atualizar?  
  Selecione o tipo de quarto desejado.

- Quais as datas e total de apartamento a atualizar?  
  Informe o período desejado, podendo **+ Adicionar outro período**.

- Total de Apartamentos: informe a quantidade total do tipo de quarto selecionado.
