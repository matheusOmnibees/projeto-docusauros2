---
sidebar_label: Tarifarios e Disponibilidade Inventario Guia Rapido
title: Tarifários e Disponibilidade Inventário Guia Rápido
description: Neste guia, você aprenderá como utilizar e interpretar as informações da aba de inventário.
slug: /
---

# Tarifários e Disponibilidade Inventário Guia Rápido
...
- a quantidade de quartos **“Disponíveis por Allotment”**:  
  o exibindo os tarifários com **‘tipo de disponibilidade: tarifário com impacto no inventário’** - _neste exemplo, os tarifários têm nomes de:_ _“Tarifa c/ Impacto e Tarifa c/ Impacto Derivado”_.  

### Atualizar Disponibilidade

Ao clicar no botão **‘Atualizar’**, será possível fazer a atualização de inventário por **_‘Disponibilidade’_**, **_‘Ocupação’_** ou **_‘Total de apartamento por período’_**.  
...
- Quais as datas a atualizar?  
  o **De – Até:** informar o período que deseja atualizar, podendo _‘+ Adicionar outro período’_.  
- Quais os quartos e disponibilidades a atualizar?  
  o **Tipos de Quarto:** selecionar o tipo de quarto desejado, podendo _‘+ Adicionar outro quarto’_.  
...
- Quais as datas e total de apartamento a atualizar?  
  o **De – Até:** informar o período que deseja atualizar. E será possível _‘+ Adicionar outro período’_.  
...
No canto superior direito da aba, existe a opção **‘Fechar Filtros’**, que permite ocultar os campos e botões de _Data_, _Vista Simples/Vista Detalhada_, _Apartamentos_ e _i – Informação_:  
